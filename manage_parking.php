...
<a href="guard_profile.php"><input type ="button" class ="btnLogin" name ="go2" value="DASHBOARD"></a>
    ...
    <tr>
        ...
        <tr>
            <td colspan="4">
                ...
                if($f['status']==0){?>
                <ul>
                	<li><a href="add_parking.php?tid=<?php echo $f['space_id']; ?>"><input type="button" name="ques" value="ADD PARKING" /></a></li>
                    <?php }else if($f['status']==1){?>
                    <li><a href="deleteparking_guard.php?del=<?php echo $f['space_id']; ?>" ><input type="button" name="delete" value="DELETE PARKING" />
                    </a></li>
                 </ul>   
            </td>
        </tr>
